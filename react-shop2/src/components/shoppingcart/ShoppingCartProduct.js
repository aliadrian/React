...
import { deleteProductFromCart, removeFromCart, addToCart } from '../../store/actions/cartActions'
      ...
      <div className="cart-item">
        <div className="p-2 d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <img style={style} src={product.image} alt="/#" className="img-fluid img-width" />
            <div>
              <div>
